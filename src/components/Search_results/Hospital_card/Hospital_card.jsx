...
function Hospital_card({results,hospitals,doctors}) {
    ...
    return (
     <div>
        { hospitals && hospitals.map((hospital)=>{ return <div key={hospital.id}>
     ...
     <CardBody>
       ...
       <CardSubtitle tag="h6" className="mb-4 text-muted"><FaPhoneAlt className="result-icon ml-4"/><span className='ml-2'>{hospital.phone}</span></CardSubtitle>
       <CardSubtitle tag="h6" className="mb-4 text-muted"><HiLocationMarker className="result-icon ml-4"/> <span className='ml-2'>{hospital.address.governorate}</span></CardSubtitle>
       <CardSubtitle tag="h6" className="mb-4 text-muted"><FaMobileAlt className="result-icon ml-4"/><span className='ml-2'> {hospital.mobile}</span> </CardSubtitle>
       <CardSubtitle tag="h6" className="mb-4 text-muted"><BiHealth className="result-icon ml-4"/> <span className='ml-2'>avilable intensive rooms: {hospital.intensiveCares}</span> </CardSubtitle>
     ...
     <CardBody>
       ...
       <CardSubtitle tag="h6" className="mb-4 font-weight-bold">{resultDoctor.hospitalTitle}</CardSubtitle>
